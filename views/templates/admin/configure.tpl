    ...
    <form action="" id="priceRuleForm">
        <div class="panel" id="fieldset_0" style="position: relative;">
            ...
            <div class="panel-heading">
                <i class="icon-plus-sign"></i> {l s='Add a rule' d='Modules.Custompricerule.Admin'}
            </div>

            <div style="display: grid;">
                <div class="form-group 1">
                    <label for="groupShop" style="text-align: end;" class="control-label col-lg-4 required">{l s='Shop'
                        d='Modules.Custompricerule.Admin'}</label>
                    <div class="col-lg-8">
            ...
            <div class="panel-footer">
                <button type="submit" class="btn btn-default pull-right">
                    <i class="process-icon-save"></i> {l s='Apply rule' d='Modules.Custompricerule.Admin'}
                </button>
            </div>
        </div>
    </form>